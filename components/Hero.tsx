  ...
  return (
    <div className='h-[calc(100vh-64px)] w-full mx-auto  container flex flex-col items-center justify-center p-4'>
      <div className='w-full flex flex-col items-center text-center gap-6'>
        <h1 className={`w-full max-w-4xl text-3xl md:text-6xl font-serif   ${instrumentSerif.className}`}>
        Puter.js brings free, serverless, Cloud and AI directly to your frontend JavaScript with no backend code or API keys required.         </h1>

        <p className='max-w-3xl  text-muted-foreground uppercase tracking-wider px-4'>
         The Puter.js AI feature allows you to integrate artificial intelligence
